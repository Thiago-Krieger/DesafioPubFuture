...
namespace DesafioPubFuture.Controllers
{
    public class ReceitasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReceitaId,Valor,DataRecebimento,DataRecebimentoEsperado,Descricao,TipoReceita,ContaId")] Receita receita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReceitaId,Valor,DataRecebimento,DataRecebimentoEsperado,Descricao,TipoReceita,ContaId")] Receita receita)
        {
